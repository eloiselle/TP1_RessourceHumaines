...
public class Candidat {
    ...
    @ManyToOne
    @JoinColumn(name = "competence_acquired", insertable = false)
    private CompetenceAcquired competenceAcquired;
    public CompetenceAcquired getCompetenceAcquired()                   { return competenceAcquired; }
    public void setCompetenceAcquired(CompetenceAcquired competenceAcquired) { this.competenceAcquired = competenceAcquired; }
