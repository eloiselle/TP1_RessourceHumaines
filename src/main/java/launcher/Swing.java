...
public class Swing {
	...
	private JLabel lblEntrepriseHeader[] = { new JLabel("Offre d'emploi"), new JLabel("Entreprise"),
			new JLabel("Téléphone"), new JLabel("Courriel"), new JLabel("Date fin"), new JLabel("Nombre postes") };
	...
	// Candidat
	private JLabel lblCandidatHeader[] = { new JLabel("Candidat"), new JLabel("Téléphone"), new JLabel("Courriel"),
